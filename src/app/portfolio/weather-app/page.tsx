...
import WeatherBanner from "@/app/ui/weather-app/weather-banner";
            ...
            <div className="max-w-screen-xl text-gray-500 w-full mx-auto py-6">
                ...
                <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <div className="flex grow flex-col rounded-lg bg-gray-100 p-6 md:w-3/4">
                        ...
                        <p className="italic text-gray-400">This react app will demonstrate pulling data from a weather app. It will showcase multiple levels of JSON object properties while adding Tailwind styling to the data.</p>
                    </div>
                </div>
